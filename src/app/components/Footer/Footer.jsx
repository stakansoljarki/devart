      ...
      <div className="footer__content">
        <div className="footer__info">
          ...
          <p className="footer__description">
            Founded in 1997, Devart is currently one of the leading developers of database
            management software, ALM solutions and data providers for most popular database servers.
          </p>
