      ...
      <div className="video-guide__container">
        ...
        <div className="video-guide__content-wrap">
          <div className="video-guide__content">
            ...
            <p className="video-guide__description">
              Being an advanced SQL IntelliSense tool, SQL Complete helps most of these benefits
              have an immediate effect. It offers valid context-specific suggestions to speed up
              query writing. During typing, it conveniently leads the user through the syntax of SQL
