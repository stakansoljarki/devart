      ...
      <div className="indicators__container">
        ...
        <div className="indicators__cards">
          <div className="indicators__card">
            ...
            <p className="indicators__card-description">
              Code faster with contexr-sensitive auto-completion, quick object information, instant
              code formatting, and smart refactoring Boost your productivity significantly with
            </p>
          </div>
          <div className="indicators__card">
            ...
            <p className="indicators__card-description">
              Code faster with contexr-sensitive auto-completion, quick object information, instant
              code formatting, and smart refactoring Boost your productivity significantly
            </p>
          </div>
          <div className="indicators__card">
