    ...
    <section className="offer">
      <div className="offer__container">
        ...
        <div className="offer__discount">
          ...
          <h4 className="offer__discount-title">
            Buy multiple licenses with a substantial discount
          </h4>
          <p className="offer__discount-description">
            We provide flexible purchase options, including bulk discounts, to meet the budget of
          ...
          <div className="offer__discount-info">
            ...
            <Link className="offer__link" href="/" isWhite>
              Purchase now
            </Link>
          </div>
        </div>
