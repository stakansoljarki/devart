    ...
    <div className="about__container">
      <div className="about__content-wrap">
        <div className="about__content">
          ...
          <p className="about__description">
            Write, beautify, refactor your SQL code easily and boost your productivity dramatically
            due to the features that are included in SQL Complete but are lacking in Management
            Studio and Visual Studio IntelliSense.
          </p>
        ...
        <div className="about__content">
          <AccordionList>
            {accordionListData.map((accordionListItem) => (
              <AccordionListItem
