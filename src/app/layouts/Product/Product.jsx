        ...
        <section className="product">
            <div className="product__container">
                <div className="product__content">
                    ...
                    <p className="product__description">An advanced IntelliSense-style code completion add-in for SSMS and VS</p>
                ...
                <a href="/" className="product__offer-link">Free edition available</a>
